...
export default function ImageCard() {
    return (
        <div className="w-[290px] h-[220px] bg-[rgba(30,37,36,1)] shadow-[0px_2px_6px_rgba(19,18,66,0.07)] border flex min-h-[220px] flex-col overflow-hidden items-center justify-around px-[41px] py-5 rounded-xl border-[rgba(239,240,246,1)] border-solid">
